...
//Clase que nos permite coger las sub imagenes de la spritesheet y crear las imagenes, siendo estas personajes, entidades estaticas o tiles
public class Assets {
...
public void init(){
	...
	SpriteSheet sheet = new SpriteSheet(images.loadImage("/Images/sheet.png"));
